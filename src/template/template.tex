...
% Required by Lulu
% Taken from http://tex.stackexchange.com/questions/36880/insert-a-blank-page-after-current-page
...
\includegraphics[width=9cm]{src/template/images/spaaace.pdf}
...
\includegraphics[width=3cm]{src/template/images/brand.pdf}
...
% Blank page as required by Lulu ----------------
